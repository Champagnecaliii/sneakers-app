...
const CreateCollection = () => {
  ...
  return (
    <div className={`container ${isDarkModeOn ? 'dark-mode' : ''}`}>
      <h2 className={`mt-4 ${isDarkModeOn ? 'text-white' : ''}`}>Create your own collection</h2>
      <div className="row">
        <div className="col-md-6">
          <form>
            <div className="mb-3">
              <label htmlFor="sneakersName" className={`form-label ${isDarkModeOn ? 'text-white' : ''}`}>
                Sneakers Name
              </label>
              <input
                type="text"
            ...
            <div className="mb-3">
              <label htmlFor="brand" className={`form-label ${isDarkModeOn ? 'text-white' : ''}`}>
                Brand
              </label>
              <input
                type="text"
            ...
            <div className="mb-3">
              <label htmlFor="color" className={`form-label ${isDarkModeOn ? 'text-white' : ''}`}>
                Color
              </label>
              <input
                type="text"
            ...
            <div className="mb-3">
              <label htmlFor="releaseDate" className={`form-label ${isDarkModeOn ? 'text-white' : ''}`}>
                Release Date
              </label>
              <input
                type="text"
            ...
            <div className="mb-3">
              {uploadingImg ? (
                ...
                <>
                  <label htmlFor="img" className={`form-label ${isDarkModeOn ? 'text-white' : ''}`}>
                    Sneakers Image
                  </label>
                  <input
                    required
