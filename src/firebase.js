...
const firebaseConfig = {
    ...
    databaseURL: "https://collection-app-4ed32-default-rtdb.asia-southeast1.firebasedatabase.app",
  ...
  export { auth, db, imgDB, createUserWithEmailAndPassword, signInWithEmailAndPassword, signOut };